...
public class csvManager
{
	...
	public int[] getCSVLength (string dataPath)
	{
		string data;
	...
	public string[,] ReadFile (string dataPath)
	{
		string data;
		//データが存在するか確認/なければnullを返す
		if (File.Exists (dataPath) == false) {
	...
	public static string[,] ReadFilesInResources (string dataPath)
	{
	...
	//CSVデータに2次元配列を上書きする
	public void WriteData (string dataPath, string[,] newData)
	{
	...
	public string[,] AddStringArrayToCSV (string[,] arrayData, string[] data)
	{
